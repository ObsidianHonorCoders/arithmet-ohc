/// @file      bot_header.hpp
/// @brief     Header file for Luis's arithmetic bot implementation.
/// @author    Calileus
/// @date      2026-03-10
/// @copyright 2026 Obsidian Honor Coders. Licensed under Apache 2.0.
/// @see       https://github.com/ObsidianHonorCoders/arithmet-ohc
/// @details   Defines the interface for Luis's arithmetic calculation bot.

#ifndef LUIS_BOT_HEADER_HPP
#define LUIS_BOT_HEADER_HPP

#include <string>

/// @namespace luis_aritmetic_bot
/// @brief     Namespace containing Luis's arithmetic bot implementation.
