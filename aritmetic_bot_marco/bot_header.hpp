/// @file      bot_header.hpp
/// @brief     Header file for Marco's arithmetic bot implementation.
/// @author    Calileus
/// @date      2026-03-10
/// @copyright 2026 Obsidian Honor Coders. Licensed under Apache 2.0.
/// @see       https://github.com/ObsidianHonorCoders/arithmet-ohc
/// @details   Defines the interface for Marco's arithmetic calculation bot.

#ifndef MARCO_BOT_HEADER_HPP
#define MARCO_BOT_HEADER_HPP

#include <string>

/// @namespace marco_aritmetic_bot
/// @brief     Namespace containing Marco's arithmetic bot implementation.
